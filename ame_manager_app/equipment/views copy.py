...
def borrowed_equipment():
    ...
    _borrowed_devices = EquipmentModel.query.filter_by(
        current_user_id=current_user.id
    ).all()

    return render_template(
        "equipment/my_tasks.html", all_tasks=_borrowed_devices, _active_tasks=True
    )
...
def view_equipment(id):
    ...
    return render_template("equipment/view_task.html", task=_equipment)
...
def edit_equipment(id):
    ...
    return render_template(
        "equipment/edit_task.html", form=_form, task=_equipment, _active_tasks=True
    )
